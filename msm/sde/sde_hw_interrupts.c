...
#define MDP_INTR_ROI_MISR_0_OFF	0x82824
#define MDP_INTR_ROI_MISR_1_OFF	0x82884
#define MDP_INTR_ROI_MISR_2_OFF	0x828E4
#define MDP_INTR_ROI_MISR_3_OFF	0x82944
#define MDP_INTR_ROI_MISR_4_OFF	0x829A4
#define MDP_INTR_ROI_MISR_5_OFF	0x82A04
#define MDP_INTR_ROI_MISR_EN_OFF	0x0
#define MDP_INTR_ROI_MISR_STATUS_OFF	0x4
#define MDP_INTR_ROI_MISR_CLEAR_OFF	0x8
...
/**
 * ROI MISR mismatch interrupt bit definitions
 */
#define SDE_INTR_ROI_MISR_ROI0_MISMATCHED BIT(0)
#define SDE_INTR_ROI_MISR_ROI1_MISMATCHED BIT(1)
#define SDE_INTR_ROI_MISR_ROI2_MISMATCHED BIT(2)
#define SDE_INTR_ROI_MISR_ROI3_MISMATCHED BIT(3)
...
static struct sde_irq_type sde_irq_map[] = {
	...
	/* BEGIN MAP_RANGE: 384-415 ROI_MISR_0 INTR */
	/* irq_idx: 384-387 */
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_0,
		SDE_INTR_ROI_MISR_ROI0_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_0,
		SDE_INTR_ROI_MISR_ROI1_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_0,
		SDE_INTR_ROI_MISR_ROI2_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_0,
		SDE_INTR_ROI_MISR_ROI3_MISMATCHED, -1},
	/* irq_idx: 388-391 */
	{ SDE_IRQ_TYPE_RESERVED, 0, 0, -1},
	{ SDE_IRQ_TYPE_RESERVED, 0, 0, -1},
	{ SDE_IRQ_TYPE_RESERVED, 0, 0, -1},
	...
	/* BEGIN MAP_RANGE: 416-447 ROI_MISR_1 INTR */
	/* irq_idx: 416-419 */
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_1,
		SDE_INTR_ROI_MISR_ROI0_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_1,
		SDE_INTR_ROI_MISR_ROI1_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_1,
	...
	/* BEGIN MAP_RANGE: 448-479 ROI_MISR_2 INTR */
	/* irq_idx: 448-451 */
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_2,
		SDE_INTR_ROI_MISR_ROI0_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_2,
		SDE_INTR_ROI_MISR_ROI1_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_2,
	...
	/* BEGIN MAP_RANGE: 480-511 ROI_MISR_3 INTR */
	/* irq_idx: 480-483 */
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_3,
		SDE_INTR_ROI_MISR_ROI0_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_3,
		SDE_INTR_ROI_MISR_ROI1_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_3,
	...
	/* BEGIN MAP_RANGE: 512-543 ROI_MISR_4 INTR */
	/* irq_idx: 512-515 */
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_4,
		SDE_INTR_ROI_MISR_ROI0_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_4,
		SDE_INTR_ROI_MISR_ROI1_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_4,
	...
	/* BEGIN MAP_RANGE: 544-575 ROI_MISR_5 INTR */
	/* irq_idx: 544-547 */
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_5,
		SDE_INTR_ROI_MISR_ROI0_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_5,
		SDE_INTR_ROI_MISR_ROI1_MISMATCHED, -1},
	{ SDE_IRQ_TYPE_ROI_MISR, ROI_MISR_5,
	...
	for (idx = 0; idx < irq_tbl_size; idx++) {
		...
		case MDSS_INTF_TEAR_2_INTR:
			...
			sde_irq->status_off = MDP_INTF_TEAR_INTF_2_IRQ_OFF +
				MDP_INTF_TEAR_INTR_STATUS_OFF;
			break;
		case MDSS_INTR_ROI_MISR_0_INTR:
			sde_irq->clr_off = MDP_INTR_ROI_MISR_0_OFF +
				MDP_INTR_ROI_MISR_CLEAR_OFF;
			sde_irq->en_off = MDP_INTR_ROI_MISR_0_OFF +
				MDP_INTR_ROI_MISR_EN_OFF;
			sde_irq->status_off = MDP_INTR_ROI_MISR_0_OFF +
				MDP_INTR_ROI_MISR_STATUS_OFF;
			break;
		case MDSS_INTR_ROI_MISR_1_INTR:
			sde_irq->clr_off = MDP_INTR_ROI_MISR_1_OFF +
				MDP_INTR_ROI_MISR_CLEAR_OFF;
			sde_irq->en_off = MDP_INTR_ROI_MISR_1_OFF +
				MDP_INTR_ROI_MISR_EN_OFF;
			sde_irq->status_off = MDP_INTR_ROI_MISR_1_OFF +
				MDP_INTR_ROI_MISR_STATUS_OFF;
			break;
		case MDSS_INTR_ROI_MISR_2_INTR:
			sde_irq->clr_off = MDP_INTR_ROI_MISR_2_OFF +
				MDP_INTR_ROI_MISR_CLEAR_OFF;
			sde_irq->en_off = MDP_INTR_ROI_MISR_2_OFF +
				MDP_INTR_ROI_MISR_EN_OFF;
			sde_irq->status_off = MDP_INTR_ROI_MISR_2_OFF +
				MDP_INTR_ROI_MISR_STATUS_OFF;
			break;
		case MDSS_INTR_ROI_MISR_3_INTR:
			sde_irq->clr_off = MDP_INTR_ROI_MISR_3_OFF +
				MDP_INTR_ROI_MISR_CLEAR_OFF;
			sde_irq->en_off = MDP_INTR_ROI_MISR_3_OFF +
				MDP_INTR_ROI_MISR_EN_OFF;
			sde_irq->status_off = MDP_INTR_ROI_MISR_3_OFF +
				MDP_INTR_ROI_MISR_STATUS_OFF;
			break;
		case MDSS_INTR_ROI_MISR_4_INTR:
			sde_irq->clr_off = MDP_INTR_ROI_MISR_4_OFF +
				MDP_INTR_ROI_MISR_CLEAR_OFF;
			sde_irq->en_off = MDP_INTR_ROI_MISR_4_OFF +
				MDP_INTR_ROI_MISR_EN_OFF;
			sde_irq->status_off = MDP_INTR_ROI_MISR_4_OFF +
				MDP_INTR_ROI_MISR_STATUS_OFF;
			break;
		case MDSS_INTR_ROI_MISR_5_INTR:
			sde_irq->clr_off = MDP_INTR_ROI_MISR_5_OFF +
				MDP_INTR_ROI_MISR_CLEAR_OFF;
			sde_irq->en_off = MDP_INTR_ROI_MISR_5_OFF +
				MDP_INTR_ROI_MISR_EN_OFF;
			sde_irq->status_off = MDP_INTR_ROI_MISR_5_OFF +
				MDP_INTR_ROI_MISR_STATUS_OFF;
			break;
		default:
