...
/*MSCHANGE start*/
#define DSI_DISPLAY_PRIMARY_FACTORY "qcom,mdss_dsi_elgin_dsi0_c3_cmd"
#define DSI_DISPLAY_SECONDARY_FACTORY "qcom,mdss_dsi_elgin_dsi1_r2_cmd"
